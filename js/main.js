(() => {
  ...
  function zoomIn(elem) {
    ...
    switch (Number(elem.parentNode.parentNode.parentNode.dataset.page)) {
      case 1:
        angle = -30;
        break;
      case 2:
  ...
  function render() {
    ...
    handPos.x = handPos.x + distX / 10;
    handPos.y = handPos.y + distY / 10;
    hand.style.transform = `translate(${handPos.x - 60}px, ${
      handPos.y + 30
    }px)`;
